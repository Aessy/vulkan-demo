...
SolarSystem createSolarSystem()
{
    ...
    ss.defs = {
        // name       radius_km  mass_kg    sma_km      ecc  period_s     tilt     rot_s      atm    atm_color                    atm_scale  diff  norm  rough  metal  albedo
        { "Sun",      696340.0,  1.989e30,  0.0,        0.0, 0.0,         0.0,     2.16e6,    false, {1.0f, 0.9f, 0.7f},          0.00f,     -1,   -1,   1.0f,  0.0f,  {1.0f, 0.9f, 0.6f} },
        { "Mercury",  2439.7,    3.301e23,  57.9e6,     0.0, 7.6e6,       0.034,   5.067e6,   false, {0.7f, 0.7f, 0.7f},          0.00f,     -1,   -1,   0.8f,  0.0f,  {0.6f, 0.6f, 0.6f} },
        { "Venus",    6051.8,    4.867e24,  108.2e6,    0.0, 19.41e6,     3.096,   2.1e7,     true,  {0.9f, 0.8f, 0.5f},          0.05f,     -1,   -1,   0.7f,  0.0f,  {0.9f, 0.8f, 0.4f} },
        { "Earth",    6371.0,    5.972e24,  149.6e6,    0.0, 31.56e6,     0.409,   86400.0,   true,  {0.4f, 0.6f, 1.0f},          0.05f,     -1,   -1,   0.5f,  0.0f,  {0.2f, 0.4f, 0.8f} },
        { "Mars",     3389.5,    6.417e23,  227.9e6,    0.0, 59.36e6,     0.440,   88775.0,   true,  {0.8f, 0.4f, 0.2f},          0.03f,     -1,   -1,   0.7f,  0.0f,  {0.7f, 0.3f, 0.2f} },
        { "Jupiter",  69911.0,   1.898e27,  778.5e6,    0.0, 374.0e6,     0.054,   35730.0,   true,  {0.8f, 0.7f, 0.6f},          0.04f,     -1,   -1,   0.4f,  0.0f,  {0.8f, 0.7f, 0.5f} },
        { "Saturn",   58232.0,   5.683e26,  1432.0e6,   0.0, 929.3e6,     0.466,   38364.0,   true,  {0.9f, 0.85f, 0.7f},         0.06f,     -1,   -1,   0.4f,  0.0f,  {0.9f, 0.8f, 0.5f} },
        { "Uranus",   25362.0,   8.681e25,  2867.0e6,   0.0, 2651.0e6,    1.706,   62064.0,   true,  {0.5f, 0.8f, 0.9f},          0.05f,     -1,   -1,   0.3f,  0.0f,  {0.5f, 0.8f, 0.9f} },
        { "Neptune",  24622.0,   1.024e26,  4515.0e6,   0.0, 5200.0e6,    0.494,   57996.0,   true,  {0.3f, 0.5f, 0.9f},          0.05f,     -1,   -1,   0.3f,  0.0f,  {0.2f, 0.4f, 0.9f} },
    };
