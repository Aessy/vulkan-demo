...
SolarSystem createSolarSystem()
{
    ...
    { "Mercury",  2439.7,    3.301e23,  57.9e6,     0.2056, 7.6e6,       0.034,   5.067e6,   false, {0.7f, 0.7f, 0.7f}, 0.00f, -1, -1, 0.8f, 0.0f, 0.0f, {0.55f, 0.52f, 0.50f},
      { 1.738e7, 2.393e6, 4.452e7 },
      { -5.62e1, 4.18e0, 3.52e1 } },

    { "Venus",    6051.8,    4.867e24, 108.2e6,    0.0067, 19.41e6,     3.096,   2.1e7,     true,  {0.9f, 0.8f, 0.5f}, 0.05f, -1, -1, 0.7f, 0.0f, 0.0f, {0.92f, 0.84f, 0.55f},
    ...
    { "Mars",     3389.5,    6.417e23, 227.9e6,    0.0935, 59.36e6,     0.440,   88775.0,   true,  {0.8f, 0.4f, 0.2f}, 0.03f, -1, -1, 0.7f, 0.0f, 0.0f, {0.80f, 0.35f, 0.18f},
      { 1.946e8, -5.02e6, -3.978e7 },
      { 6.53e0, -6.45e-1, 2.57e1 } },

    { "Jupiter",  69911.0,   1.898e27, 778.5e6,    0.0489, 374.0e6,     0.054,   35730.0,   true,  {0.8f, 0.7f, 0.6f}, 0.04f, -1, -1, 0.4f, 0.0f, 0.0f, {0.75f, 0.63f, 0.44f},
      { -5.210e8, 9.18e6, 5.984e8 },
      { -9.55e0, 2.24e-1, -6.98e0 } },

    { "Saturn",   58232.0,   5.683e26, 1432.0e6,   0.0565, 929.3e6,     0.466,   38364.0,   true,  {0.9f, 0.85f, 0.7f}, 0.06f, -1, -1, 0.4f, 0.0f, 0.0f, {0.88f, 0.78f, 0.52f},
      { 1.352e9, -3.31e7, -4.964e8 },
      { 2.61e0, -2.55e-1, 9.18e0 } },

    { "Uranus",   25362.0,   8.681e25, 2867.0e6,   0.0461, 2651.0e6,    1.706,   62064.0,   true,  {0.5f, 0.8f, 0.9f}, 0.05f, -1, -1, 0.3f, 0.0f, 0.0f, {0.52f, 0.82f, 0.84f},
      { 1.662e9, -1.85e7, 2.267e9 },
      { -5.29e0, 7.41e-2, 3.66e0 } },

    { "Neptune",  24622.0,   1.024e26, 4515.0e6,   0.0097, 5200.0e6,    0.494,   57996.0,   true,  {0.3f, 0.5f, 0.9f}, 0.05f, -1, -1, 0.3f, 0.0f, 0.0f, {0.22f, 0.40f, 0.88f},
